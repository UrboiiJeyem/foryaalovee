let messages = ["Please?", "Give me a chance!", "Are you sure?", "Think again!", "You might regret this!", "One last chance!", "Pretty please?", "🤪🤪🤪"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">YAYAYYAYAYAYAY I LOVE YOU SO MUCH MY SWEET LITTLE KITTEN!!😚🤍</div>
    `;
    launchConfetti();
    startHeartRain();
}
